...
const Highlight = () => {
  ...
  return (
    <section className="bg-background py-16 sm:py-20 overflow-hidden">
      ...
      >
        <p className="text-primary font-heading font-semibold text-xs sm:text-sm uppercase tracking-[0.2em] mb-4 sm:mb-6">
          Vendi.Mais®
        </p>
        <h2 className="font-heading text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight px-2">
